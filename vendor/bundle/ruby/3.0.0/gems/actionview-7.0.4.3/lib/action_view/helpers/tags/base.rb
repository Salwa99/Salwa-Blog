      ...
      class Base # :nodoc:
        ...
        def select_content_tag(option_tags, options, html_options)
          ...
          if placeholder_required?(html_options)
            raise ArgumentError,
                  "include_blank cannot be false for a required field." if options[:include_blank] == false
        ...
        def add_options(option_tags, options, value = nil)
          if options[:include_blank]
            ...
            option_tags = tag_builder.content_tag_string("option", content, value: "",
                                                                            label: label) + "\n" + option_tags
          end
          ...
          if value.blank? && options[:prompt]
            ...
            option_tags = tag_builder.content_tag_string("option", prompt_text(options[:prompt]),
                                                         tag_options) + "\n" + option_tags
          end
