...
module Marcel
  ...
  TYPES = {
    ...
    'application/vnd.lotus-1-2-3;version=97+9.x' => [%w(123), %w(application/vnd.lotus-1-2-3),
    ...
    'application/vnd.ms-excel' => [%w(xls xlm xla xlc xlt xlw xll xld), %w(application/x-tika-msoffice),
                                   'Microsoft Excel Spreadsheet'],
    'application/vnd.ms-excel.addin.macroenabled.12' => [%w(xlam), %w(application/x-tika-ooxml),
                                                         'Office Open XML Workbook Add-in (macro-enabled)'],
    'application/vnd.ms-excel.sheet.binary.macroenabled.12' => [%w(xlsb), %w(application/x-tika-ooxml),
                                                                'Microsoft Excel 2007 Binary Spreadsheet'],
    'application/vnd.ms-excel.sheet.macroenabled.12' => [%w(xlsm), %w(application/x-tika-ooxml),
                                                         'Office Open XML Workbook (macro-enabled)'],
    'application/vnd.ms-excel.template.macroenabled.12' => [%w(xltm), %w(application/x-tika-ooxml),
    ...
    'application/vnd.ms-powerpoint' => [%w(ppt ppz pps pot ppa), %w(application/x-tika-msoffice),
                                        'Microsoft Powerpoint Presentation'],
    'application/vnd.ms-powerpoint.addin.macroenabled.12' => [%w(ppam), %w(application/x-tika-ooxml),
                                                              'Office Open XML Presentation Add-in (macro-enabled)'],
    'application/vnd.ms-powerpoint.presentation.macroenabled.12' => [%w(pptm), %w(application/x-tika-ooxml),
    ...
    'application/vnd.ms-powerpoint.slideshow.macroenabled.12' => [%w(ppsm), %w(application/x-tika-ooxml),
    ...
    'application/vnd.ms-visio.drawing' => [%w(vsdx), %w(application/x-tika-visio-ooxml),
                                           'Office Open XML Visio Drawing (macro-free)'],
    'application/vnd.ms-visio.drawing.macroEnabled.12' => [%w(vsdm), %w(application/x-tika-visio-ooxml),
                                                           'Office Open XML Visio Drawing (macro-enabled)'],
    'application/vnd.ms-visio.stencil' => [%w(vssx), %w(application/x-tika-visio-ooxml),
                                           'Office Open XML Visio Stencil (macro-free)'],
    'application/vnd.ms-visio.stencil.macroEnabled.12' => [%w(vssm), %w(application/x-tika-visio-ooxml),
                                                           'Office Open XML Visio Stencil (macro-enabled)'],
    'application/vnd.ms-visio.template' => [%w(vstx), %w(application/x-tika-visio-ooxml),
                                            'Office Open XML Visio Template (macro-free)'],
    'application/vnd.ms-visio.template.macroEnabled.12' => [%w(vstm), %w(application/x-tika-visio-ooxml),
                                                            'Office Open XML Visio Template (macro-enabled)'],
    'application/vnd.ms-word.document.macroenabled.12' => [%w(docm), %w(application/x-tika-ooxml),
                                                           'Office Open XML Document (macro-enabled)'],
    'application/vnd.ms-word.template.macroenabled.12' => [%w(dotm), %w(application/x-tika-ooxml),
    ...
    'application/vnd.oasis.opendocument.chart-template' => [%w(otc), %w(),
                                                            'OpenDocument v1.0: Chart document used as template'],
    'application/vnd.oasis.opendocument.flat.presentation' => [%w(fodp),
                                                               %w(application/vnd.oasis.opendocument.tika.flat.document), 'OpenDocument v1.0: Flat Presentation document'],
    'application/vnd.oasis.opendocument.flat.spreadsheet' => [%w(fods),
                                                              %w(application/vnd.oasis.opendocument.tika.flat.document), 'OpenDocument v1.0: Flat Spreadsheet document'],
    'application/vnd.oasis.opendocument.flat.text' => [%w(fodt),
                                                       %w(application/vnd.oasis.opendocument.tika.flat.document), 'OpenDocument v1.0: Flat Text document'],
    'application/vnd.oasis.opendocument.formula' => [%w(odf), %w(application/zip),
                                                     'OpenDocument v1.0: Formula document'],
    'application/vnd.oasis.opendocument.formula-template' => [%w(odft), %w(),
    ...
    'application/vnd.oasis.opendocument.graphics-template' => [%w(otg), %w(),
    ...
    'application/vnd.oasis.opendocument.image-template' => [%w(oti), %w(),
    ...
    'application/vnd.oasis.opendocument.presentation-template' => [%w(otp), %w(),
    ...
    'application/vnd.oasis.opendocument.spreadsheet-template' => [%w(ots), %w(),
    ...
    'application/vnd.oasis.opendocument.text-template' => [%w(ott), %w(),
                                                           'OpenDocument v1.0: Text document used as template'],
    'application/vnd.oasis.opendocument.text-web' => [%w(oth), %w(),
    ...
    'application/vnd.openxmlformats-officedocument.presentationml.presentation' => [%w(pptx thmx),
                                                                                    %w(application/x-tika-ooxml), 'Office Open XML Presentation'],
    ...
    'application/vnd.openxmlformats-officedocument.presentationml.slideshow' => [%w(ppsx),
                                                                                 %w(application/x-tika-ooxml), 'Office Open XML Presentation Slideshow'],
    'application/vnd.openxmlformats-officedocument.presentationml.template' => [%w(potx), %w(application/x-tika-ooxml),
                                                                                'Office Open XML Presentation Template'],
    'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' => [%w(xlsx), %w(application/x-tika-ooxml),
                                                                            'Office Open XML Workbook'],
    'application/vnd.openxmlformats-officedocument.spreadsheetml.template' => [%w(xltx), %w(application/x-tika-ooxml),
                                                                               'Office Open XML Workbook Template'],
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document' => [%w(docx),
                                                                                  %w(application/x-tika-ooxml), 'Office Open XML Document'],
    'application/vnd.openxmlformats-officedocument.wordprocessingml.template' => [%w(dotx),
                                                                                  %w(application/x-tika-ooxml), 'Office Open XML Document Template'],
    ...
    'application/x-mysql-misam-compressed-index' => [%w(myi), %w(application/x-mysql-db),
    ...
    'application/x-quattro-pro;version=1+5' => [%w(wb1), %w(application/x-quattro-pro),
                                                'Quattro Pro for Windows, version 1, 5'],
    'application/x-quattro-pro;version=1-4' => [%w(wq1 wkq), %w(application/x-quattro-pro),
                                                'Quattro Pro for DOS, version 1-4'],
    'application/x-quattro-pro;version=5' => [%w(wq2 wkq), %w(application/x-quattro-pro),
                                              'Quattro Pro for DOS, version 5'],
    'application/x-quattro-pro;version=6' => [%w(wb2), %w(application/x-quattro-pro),
    ...
    'image/x-freehand' => [%w(fh fhc fh4 fh40 fh5 fh50 fh7 fh8 fh9 fh10 fh11 fh12 ft7 ft8 ft9 ft10 ft11 ft12), %w(),
                           'FreeHand image'],
    ...
    'text/plain' => [
      %w(txt text def list in aart ac am apt bsh classpath cnd cwiki data dcl dsp dsw egrm ent ft fn fv grm g handlers htc
         ihtml jmx junit jx manifest m4 mf mf meta mdo n3 pen pod pom project rng rnx roles schemas tld types vm vsl wsdd xargs xcat xegrm xgrm xlex xlog xmap xroles xsamples xsp xtest xweb xwelcome), %w(), nil
    ],
  ...
  MAGIC = [
    ...
    ['image/bmp',
     [[0, 'BM',
       [[26, "\001\000", [[28, "\000\000"], [28, "\001\000"], [28, "\004\000"], [28, "\b\000"], [28, "\020\000"], [28, "\030\000"], [28, " \000"]]]]]]],
    ...
    ['video/quicktime',
     [[4, "moov\000"], [4, "mdat\000"], [4, "free\000"], [4, "skip\000"], [4, "pnot\000"], [4, 'ftyp'],
      [0, "\000\000\000\bwide"]]],
    ['video/mpeg', [[0, "\000\000\001\263"], [0, "\000\000\001\272"]]],
    ['video/webm',
     [[0, "\032E\337\243", [[4..4096, "B\202", [[4..4096, 'webm', [[4..4096, 'V_VP8'], [4..4096, 'V_VP9']]]]]]]]],
    ['video/x-matroska', [[0, "\032E\337\243\223B\202\210matroska"]]],
    ['video/x-flv', [[0, 'FLV']]],
    ['audio/mpeg',
     [[0, "\377\362"], [0, "\377\363"], [0, "\377\364"], [0, "\377\365"], [0, "\377\366"], [0, "\377\367"], [0, "\377\372"],
      [0, "\377\373"], [0, "\377\374"], [0, "\377\375"], [0, "\377\377"], [0, 'ID3']]],
    ...
    ['application/vnd.openxmlformats-officedocument.wordprocessingml.document',
     [[0, "PK\003\004",
       [[30..65536, '[Content_Types].xml', [[0..4096, 'word/']]], [30, '_rels/.rels', [[0..4096, 'word/']]]]]]],
    ['application/vnd.ms-powerpoint',
     [[0..8, "\320\317\021\340\241\261\032\341",
       [[1152..4096, "P\000o\000w\000e\000r\000P\000o\000i\000n\000t\000 D\000o\000c\000u\000m\000e\000n\000t"]]]]],
    ['application/vnd.openxmlformats-officedocument.presentationml.presentation',
     [[0, "PK\003\004",
       [[30..65536, '[Content_Types].xml', [[0..4096, 'ppt/']]], [30, '_rels/.rels', [[0..4096, 'ppt/']]]]]]],
    ['application/vnd.ms-excel',
     [[2080, 'Microsoft Excel 5.0 Worksheet'], [2080, 'Foglio di lavoro Microsoft Exce'], [2114, 'Biff5'], [2121, 'Biff5'],
      [0..8, "\320\317\021\340\241\261\032\341", [[1152..4096, "W\000o\000r\000k\000b\000o\000o\000k"]]]]],
    ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
     [[0, "PK\003\004",
       [[30..65536, '[Content_Types].xml', [[0..4096, 'xl/']]], [30, '_rels/.rels', [[0..4096, 'xl/']]]]]]],
    ['application/x-dbf',
     [[0,
    ...
    ['image/x-tga',
     [
       [1, "\001\001\000\000",
        [[8, ".*[\\\\124\\\\122\\\\125\\\\105\\\\126\\\\111\\\\123\\\\111\\\\117\\\\116\\\\055\\\\130\\\\106\\\\111\\\\114\\\\105\\\\056\\\\000]"]]], [1, "\000\002\000\000", [[8, ".*[\\\\124\\\\122\\\\125\\\\105\\\\126\\\\111\\\\123\\\\111\\\\117\\\\116\\\\055\\\\130\\\\106\\\\111\\\\114\\\\105\\\\056\\\\000]"]]], [1, "\000\003\000\000", [[8, ".*[\\\\124\\\\122\\\\125\\\\105\\\\126\\\\111\\\\123\\\\111\\\\117\\\\116\\\\055\\\\130\\\\106\\\\111\\\\114\\\\105\\\\056\\\\000]"]]]
     ]],
    ...
    ['application/x-bplist',
     [[0, "bplist\000\000"], [0, "bplist\000\001"], [0, "bplist@\000"], [0, 'bplist00'], [0, 'bplist01'], [0, 'bplist10'],
      [0, 'bplist15'], [0, 'bplist16']]],
    ['application/x-ms-nls',
     [[0, "(?s)^\\\\015.{51}\\\\014\\\\000\\\\015\\\\000\\\\016"], [0, "(?s)^\\\\104\\\\103.\\\\001"]]],
    ['message/x-emlx',
     [[2..9, "\nRelay-Version:"], [2..9, "\n#! rnews"], [2..9, "\nN#! rnews"], [2..9, "\nForward to"], [2..9, "\nPipe to"],
      [2..9, "\nReturn-Path:"], [2..9, "\nFrom:"], [2..9, "\nReceived:"], [2..9, "\nMessage-ID:"], [2..9, "\nDate:"]]],
    ...
    ['application/vnd.ms-excel.sheet.2',
     [[0, "\t\000\004\000", [[4, "\000\000\020\000"], [4, "\000\000 \000"], [4, "\000\000@\000"]]]]],
    ['application/vnd.ms-excel.sheet.3',
     [[0, "\t\002\006\000", [[4, "\000\000\020\000"], [4, "\000\000 \000"], [4, "\000\000@\000"]]]]],
    ['application/vnd.ms-excel.sheet.4',
     [[0, "\t\004\006\000", [[4, "\000\000\020\000"], [4, "\000\000 \000"], [4, "\000\000@\000"]]]]],
    ...
    ['application/x-berkeley-db;format=btree;version=2',
     [[12, "b1\005\000", [[16, "\006\000\000\000"]]], [12, "\000\0051b", [[16, "\000\000\000\006"]]],
      [12, "b1\005\000", [[16, "\006\000\000\000"]]]]],
    ['application/x-berkeley-db;format=btree;version=3',
     [[12, "b1\005\000", [[16, "\b\000\000\000"]]], [12, "\000\0051b", [[16, "\000\000\000\b"]]],
      [12, "b1\005\000", [[16, "\b\000\000\000"]]]]],
    ['application/x-berkeley-db;format=btree;version=4',
     [[12, "b1\005\000", [[16, "\t\000\000\000"]]], [12, "\000\0051b", [[16, "\000\000\000\t"]]],
      [12, "b1\005\000", [[16, "\t\000\000\000"]]]]],
    ['application/x-berkeley-db;format=hash;version=2',
     [[12, "a\025\006\000", [[16, "\005\000\000\000"]]], [12, "\000\006\025a", [[16, "\000\000\000\005"]]],
      [12, "a\025\006\000", [[16, "\005\000\000\000"]]]]],
    ['application/x-berkeley-db;format=hash;version=3',
     [[12, "a\025\006\000", [[16, "\a\000\000\000"]]], [12, "\000\006\025a", [[16, "\000\000\000\a"]]],
      [12, "a\025\006\000", [[16, "\a\000\000\000"]]]]],
    ['application/x-berkeley-db;format=hash;version=4',
     [[12, "a\025\006\000", [[16, "\b\000\000\000"]]], [12, "\000\006\025a", [[16, "\000\000\000\b"]]],
      [12, "a\025\006\000", [[16, "\b\000\000\000"]]]]],
    ['application/x-berkeley-db;format=hash;version=5',
     [[12, "a\025\006\000", [[16, "\t\000\000\000"]]], [12, "\000\006\025a", [[16, "\000\000\000\t"]]],
      [12, "a\025\006\000", [[16, "\t\000\000\000"]]]]],
    ...
    ['application/x-msdownload;format=pe-arm7',
     [[128, "pe\000\000", [[132, "\304\001"]]], [240, "pe\000\000", [[244, "\304\001"]]]]],
    ['application/x-msdownload;format=pe-armLE',
     [[128, "pe\000\000", [[132, "\300\001"]]], [240, "pe\000\000", [[244, "\300\001"]]]]],
    ['application/x-msdownload;format=pe-itanium',
     [[128, "PE\000\000", [[132, "\000\002"]]], [240, "PE\000\000", [[244, "\000\002"]]]]],
    ['application/x-msdownload;format=pe32',
     [[128, "PE\000\000", [[132, "L\001"]]], [240, "PE\000\000", [[244, "L\001"]]]]],
    ['application/x-msdownload;format=pe64',
     [[128, "PE\000\000", [[132, "d\206"]]], [240, "PE\000\000", [[244, "d\206"]]]]],
    ...
    ['application/x-tika-msworks-spreadsheet',
     [[0..8, "\320\317\021\340\241\261\032\341",
       [[1152..4096, "W\000k\000s\000S\000S\000W\000o\000r\000k\000B\000o\000o\000k"]]]]],
    ['audio/opus', [[0, 'OggS', [[29, 'pusHead']]]]],
    ['audio/speex', [[0, 'OggS', [[29, 'peex   ']]]]],
    ['audio/vorbis', [[0, 'OggS', [[29, 'vorbis']]]]],
    ['audio/x-caf',
     [[0, "caff\000\000"], [0, "caff\000\001"], [0, "caff\000\002"], [0, "caff@\000"], [0, "caff\200\000"]]],
    ...
    ['multipart/related',
     [[0, 'From: <Saved by Windows Internet Explorer 8>'], [0, "From: \"Saved by Internet Explorer 11\""],
      [0, 'MIME-Version: 1.0', [[16..512, "\nContent-Type: multipart/related"]]]]],
    ['video/3gpp',
     [[4, 'ftyp3ge6'], [4, 'ftyp3ge7'], [4, 'ftyp3gg6'], [4, 'ftyp3gp1'], [4, 'ftyp3gp2'], [4, 'ftyp3gp3'], [4, 'ftyp3gp4'],
      [4, 'ftyp3gp5'], [4, 'ftyp3gp6'], [4, 'ftyp3gs7']]],
    ...
    ['application/x-msdownload;format=pe',
     [[0, 'MZ', [[128, "PE\000\000"], [176, "PE\000\000"], [208, "PE\000\000"], [240, "PE\000\000"]]]]],
    ...
    ['application/javascript',
     [[0, '/* jQuery '], [0, '/*! jQuery '], [0, '/*!', [[4..8, '* jQuery ']]], [0, '(function(e,undefined){'],
      [0, '!function(window,undefined){'], [0, '/*  Prototype JavaScript '], [0, 'var Prototype={'], [0, 'function $w(t){'], [0, '/** @license React'], [0, '/**', [[4..8, '* React ']]]]],
    ['application/mac-binhex40', [[11, 'must be converted with BinHex']]],
    ['application/mathematica', [[0, '(**'], [0, '(* ']]],
    ['application/msword',
     [[2080, 'Microsoft Word 6.0 Document'], [2080, 'Documento Microsoft Word 6'], [2112, 'MSWordDoc'],
      [0, "1\276\000\000"], [0, 'PO^Q`'], [0, "\3767\000#"], [0, "\333\245-\000\000\000"], [0, "\224\246."], [0..8, "\320\317\021\340\241\261\032\341", [[1152..4096, "W\000o\000r\000d\000D\000o\000c\000u\000m\000e\000n\000t"]]]]],
    ['application/msword2', [[0, "\233\245"], [0, "\333\245"]]],
    ['application/msword5', [[0, "\3767"]]],
    ['application/octet-stream',
     [[10, '# This is a shell archive'], [0, "\037\036"], [0, "\037\037"], [0, "\377\037"], [0, "\377\037"],
      [0, "\005\313"]]],
    ['application/ogg', [[0, 'OggS']]],
    ['application/onenote;format=one',
     [[0, "\344R\\{", [[4, "\214\330", [[6, "\247M", [[8, '0xAEB15378D02996D3']]]]]]]]],
    ['application/onenote;format=onetoc2',
     [[0, "\241/\377C", [[4, "\331\357", [[6, 'vL', [[8, '0x9EE210EA5722765F']]]]]]]]],
    ['application/pkcs7-signature',
     [[0, '-----BEGIN PKCS7'], [0, '0x3080', [[0, "\006\t*\206H\206\367\r\001\a", [[11, "\240"]]]]],
      [0, '0x3081', [[0, "\006\t*\206H\206\367\r\001\a", [[11, "\240"]]]]], [0, '0x3082', [[0, "\006\t*\206H\206\367\r\001\a", [[11, "\240"]]]]], [0, '0x3083', [[0, "\006\t*\206H\206\367\r\001\a", [[11, "\240"]]]]], [0, '0x3084', [[0, "\006\t*\206H\206\367\r\001\a", [[11, "\240"]]]]]]],
    ...
    ['application/vnd.mif',
     [[0, '<MakerFile'], [0, '<MIFFile'], [0, '<MakerDictionary'], [0, '<MakerScreenFont'], [0, '<MML'], [0, '<Book'],
      [0, '<Maker']]],
    ...
    ['application/vnd.ms-works',
     [[0..8, "\320\317\021\340\241\261\032\341", [[1152..4096, "M\000a\000t\000O\000S\000T"]]]]],
    ...
    ['application/vnd.stardivision.impress',
     [[0..8, "\320\317\021\340\241\261\032\341", [[2048..2207, 'StarImpress']]]]],
    ...
    ['application/x-berkeley-db;format=btree',
     [[0, "b1\005\000"], [0, "\000\0051b"], [0, "b1\005\000"], [12, "b1\005\000"], [12, "\000\0051b"],
      [12, "b1\005\000"]]],
    ['application/x-berkeley-db;format=hash',
     [[0, "a\025\006\000"], [0, "\000\006\025a"], [0, "a\025\006\000"], [12, "a\025\006\000"], [12, "\000\006\025a"],
      [12, "a\025\006\000"]]],
    ...
    ['application/x-bibtex-text-file',
     [[0, '% BibTeX `'], [73, '%%%  '], [0, '% BibTeX standard bibliography '], [73, '%%%  @BibTeX-style-file{'],
      [0, '@article{'], [0, '@book{'], [0, '@inbook{'], [0, '@incollection{'], [0, '@inproceedings{'], [0, '@manual{'], [0, '@misc{'], [0, '@preamble{'], [0, '@phdthesis{'], [0, '@string{'], [0, '@techreport{'], [0, '@unpublished{']]],
    ...
    ['application/x-java-jnilib',
     [[0, "\312\376\272\276",
       [[4096, "\376\355\372\316"], [4096, "\376\355\372\317"], [4096, "\316\372\355\376"], [4096, "\317\372\355\376"]]]]],
    ['application/x-kdelnk', [[0, '[KDE Desktop Entry]'], [0, '# KDE Config File']]],
    ['application/x-latex', [[0, '% -*-latex-*-']]],
    ['application/x-lha',
     [[2, '-lzs-'], [2, '-lh -'], [2, '-lhd-'], [2, '-lh2-'], [2, '-lh3-'], [2, '-lh4-'], [2, '-lh5-'], [2, '-lh6-'],
      [2, '-lh7-']]],
    ...
    ['application/x-tex',
     [[0, "\\input"], [0, "\\section"], [0, "\\setlength"], [0, "\\documentstyle"], [0, "\\chapter"],
      [0, "\\documentclass"], [0, "\\relax"], [0, "\\contentsline"]]],
    ...
    ['application/x-x509-key;format=pem',
     [[0, '-----BEGIN PRIVATE KEY-----'], [0, '-----BEGIN PUBLIC KEY-----'], [0, '-----BEGIN KEY-----'],
      [0, '-----BEGIN RSA KEY-----'], [0, '-----BEGIN RSA PRIVATE KEY-----'], [0, '-----BEGIN DSA KEY-----'], [0, '-----BEGIN DSA PRIVATE KEY-----']]],
    ['application/x-xz', [[0, "\3757zXZ\000"]]],
    ['application/x-zoo', [[20, "\334\247\304\375"]]],
    ['application/xml',
     [[0, '<?xml'], [0, '<?XML'], [0, "\357\273\277<?xml"], [0, "\377\376<\000?\000x\000m\000l\000"],
      [0, "\376\377\000<\000?\000x\000m\000l"]]],
    ...
    ['audio/webm',
     [[0, "\032E\337\243", [[4..4096, "B\202", [[4..4096, 'webm', [[4..4096, 'A_VORBIS'], [4..4096, 'A_OPUS']]]]]]]]],
    ['audio/x-flac', [[0, 'fLaC']]],
    ['audio/x-mod',
     [[0, 'Extended Module:'], [21, 'BMOD2STM'], [1080, 'M.K.'], [1080, 'M!K!'], [1080, 'FLT4'], [1080, 'FLT8'],
      [1080, '4CHN'], [1080, '6CHN'], [1080, '8CHN'], [1080, 'CD81'], [1080, 'OKTA'], [1080, '16CN'], [1080, '32CN'], [0, 'IMPM']]],
    ...
    ['image/vnd.dwg',
     [[0, 'MC0.0'], [0, 'AC1.2'], [0, 'AC1.40'], [0, 'AC1.50'], [0, 'AC2.10'], [0, 'AC2.21'], [0, 'AC2.22']]],
    ...
    ['image/x-freehand',
     [[0, 'AGD2'], [0, 'AGD3'], [0, 'AGD4'], [0..24, 'FreeHand10'], [0..24, 'FreeHand11'], [0..24, 'FreeHand12']]],
    ...
    ['message/rfc822',
     [[0, 'Relay-Version:'], [0, '#! rnews'], [0, 'N#! rnews'], [0, 'Forward to'], [0, 'Pipe to'], [0, 'Return-Path:'],
      [0, 'Message-ID:'], [0, 'X-Mailer:'], [0, 'X-Notes-Item:', [[0..8192, 'Message-ID:']]], [0, nil, [[0, 'Date:'], [0, 'Delivered-To:'], [0, 'From:'], [0, 'Message-ID:'], [0, 'MIME-Version:'], [0, 'Received:'], [0, 'Relay-Version:'], [0, 'Return-Path:'], [0, 'Sent:'], [0, 'Status:'], [0, 'User-Agent:'], [0, 'X-Mailer:'], [0, 'X-Originating-IP:'], [0..1024, "\nDate:"], [0..1024, "\nDelivered-To:"], [0..1024, "\nFrom:"], [0..1024, "\nMIME-Version:"], [0..1024, "\nReceived:"], [0..1024, "\nRelay-Version:"], [0..1024, "\nReturn-Path:"], [0..1024, "\nSent:"], [0..1024, "\nStatus:"], [0..1024, "\nSubject:"], [0..1024, "\nTo:"], [0..1024, "\nUser-Agent:"], [0..1024, "\nX-Mailer:"], [0..1024, "\nX-Originating-IP:"]]], [0, '(X|DKIM|ARC)-', [[0..8192, "\nDate:"], [0..8192, "\nDelivered-To:"], [0..8192, "\nFrom:"], [0..8192, "\nMessage-ID:"], [0..8192, "\nMIME-Version:"], [0..8192, "\nReceived:"], [0..8192, "\nRelay-Version:"], [0..8192, "\nReturn-Path:"], [0..8192, "\nStatus:"], [0..8192, "\nUser-Agent:"], [0..8192, "\nX-Mailer:"], [0..8192, "\nX-Originating-IP:"]]]]],
    ...
    ['text/x-awk',
     [[0, '#!/bin/gawk'], [0, '#! /bin/gawk'], [0, '#!/usr/bin/gawk'], [0, '#! /usr/bin/gawk'],
      [0, '#!/usr/local/bin/gawk'], [0, '#! /usr/local/bin/gawk'], [0, '#!/bin/awk'], [0, '#! /bin/awk'], [0, '#!/usr/bin/awk'], [0, '#! /usr/bin/awk']]],
    ['text/x-diff', [[0, 'diff '], [0, '*** '], [0, 'Only in '], [0, 'Common subdirectories: '], [0, 'Index:']]],
    ['text/x-jsp', [[0, '<%@'], [0, '<%--']]],
    ['text/x-matlab', [[0, 'function [']]],
    ['text/x-perl',
     [[0, "eval \"exec /usr/local/bin/perl"], [0, '#!/bin/perl'], [0, '#!/bin/env perl'], [0, '#!/usr/bin/perl'],
      [0, '#!/usr/local/bin/perl']]],
    ['text/x-php', [[0, '<?php']]],
    ['text/x-python',
     [[0, '#!/bin/python'], [0, '#! /bin/python'], [0, "eval \"exec /bin/python"], [0, '#!/usr/bin/python'],
      [0, '#! /usr/bin/python'], [0, "eval \"exec /usr/bin/python"], [0, '#!/usr/local/bin/python'], [0, '#! /usr/local/bin/python'], [0, "eval \"exec /usr/local/bin/python"], [1, '/bin/env python']]],
    ...
    ['application/x-mysql-table-definition',
     [[0, "\376\001\a"], [0, "\376\001\b"], [0, "\376\001\t"], [0, "\376\001\n"], [0, "\376\001\v"],
      [0, "\376\001\f"]]],
    ...
    ['text/html',
     [[0..64, '<!DOCTYPE HTML'], [0..64, '<!DOCTYPE html'], [0..64, '<!doctype HTML'], [0..64, '<!doctype html'],
      [0..64, '<HEAD'], [0..64, '<head'], [0..64, '<TITLE'], [0..64, '<title'], [0..64, '<HTML'], [0, '<BODY'], [0, '<body'], [0, '<DIV'], [0, '<div'], [0, '<TITLE'], [0, '<title'], [0, '<h1'], [0, '<H1'], [0..128, '<html']]],
    ['text/vtt',
    ...
    ['audio/basic',
     [
       [0, '.snd',
        [[12, "\000\000\000\001"], [12, "\000\000\000\002"], [12, "\000\000\000\003"], [12, "\000\000\000\004"], [12, "\000\000\000\005"], [12, "\000\000\000\006"], [12, "\000\000\000\a"]]], [0, ".snd\000\000\000"]
     ]],
    ['audio/midi', [[0, 'MThd']]],
    ['audio/vnd.wave', [[0, 'RIFF', [[8, 'WAVE']]]]],
    ['audio/x-adpcm', [[0, '.snd', [[12, "\000\000\000\027"]]]]],
    ['audio/x-aiff',
     [[0, 'FORM', [[8, 'AIFF']]], [0, 'FORM', [[8, 'AIFC']]], [0, 'FORM', [[8, '8SVX']]], [0, "FORM\000"]]],
    ['audio/x-dec-adpcm', [[0, "\000ds.", [[12, "\000\000\000\027"]]]]],
    ['audio/x-dec-basic',
     [[0, "\000ds.",
       [[12, "\000\000\000\001"], [12, "\000\000\000\002"], [12, "\000\000\000\003"], [12, "\000\000\000\004"], [12, "\000\000\000\005"], [12, "\000\000\000\006"], [12, "\000\000\000\a"]]]]],
    ['text/html', [[128..8192, '<html']]],
    ['text/plain',
     [[0, 'This is TeX,'], [0, 'This is METAFONT,'], [0, '/*'], [0, '//'], [0, ';;'], [0, "\376\377"], [0, "\377\376"],
      [0, "\357\273\277"]]],
    ['text/x-makefile',
     [[0, '# Makefile.in generated by'], [0, '#!make'], [0, '#!/usr/bin/make'], [0, '#!/usr/local/bin/make'],
      [0, '#!/usr/bin/env make']]],
  ]
end
