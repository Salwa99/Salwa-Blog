      ...
      Net::SMTP.new(settings[:address], settings[:port]).tap do |smtp|
        ...
        if !tls.nil?
          ...
          when false
            ...
            raise ArgumentError,
                  "Unrecognized :enable_starttls value #{settings[:enable_starttls].inspect}; expected true, false, or nil"
          end
          ...
          when false
            ...
            raise ArgumentError,
                  "Unrecognized :enable_starttls_auto value #{settings[:enable_starttls_auto].inspect}; expected true, false, or nil"
          end
        end
