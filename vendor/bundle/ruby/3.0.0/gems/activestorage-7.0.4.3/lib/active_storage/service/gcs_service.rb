  ...
  class Service::GCSService < Service
    ...
    def upload(key, io, checksum: nil, content_type: nil, disposition: nil, filename: nil, custom_metadata: {})
      instrument :upload, key: key, checksum: checksum do
        ...
        bucket.create_file(io, key, md5: checksum, cache_control: @config[:cache_control], content_type: content_type,
                                    content_disposition: content_disposition, metadata: custom_metadata)
    ...
    def update_metadata(key, content_type:, disposition: nil, filename: nil, custom_metadata: {})
      instrument :update_metadata, key: key, content_type: content_type, disposition: disposition do
        file_for(key).update do |file|
          ...
          file.content_disposition = content_disposition_with(type: disposition,
