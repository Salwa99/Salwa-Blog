  ...
  module Calculations
    ...
    def execute_simple_calculation(operation, column_name, distinct) # :nodoc:
      ...
      result = skip_query_cache_if_necessary {
        @klass.connection.select_all(query_builder, "#{@klass.name} #{operation.capitalize}")
      }
    ...
    def execute_grouped_calculation(operation, column_name, distinct) # :nodoc:
      ...
      calculated_data = skip_query_cache_if_necessary {
        @klass.connection.select_all(relation.arel, "#{@klass.name} #{operation.capitalize}")
      }
