  ...
  class HasManyThroughSourceAssociationNotFoundError < ActiveRecordError # :nodoc:
    def initialize(reflection = nil)
      if reflection
        ...
        )} in model #{through_reflection.klass}. Try 'has_many #{reflection.name.inspect}, :through => #{through_reflection.name.inspect}, :source => <name>'. Is it one of #{source_associations.to_sentence(
          two_words_connector: ' or ', last_word_connector: ', or '
        )}?")
      else
  ...
  module Associations # :nodoc:
    ...
    module ClassMethods
      ...
      def has_and_belongs_to_many(name, scope = nil, **options, &extension)
        ...
        [:before_add, :after_add, :before_remove, :after_remove, :autosave, :validate, :join_table, :class_name,
         :extend, :strict_loading].each do |k|
